...
public class ListComponent extends AbstractListComponent {
    ...
    private void initComponents() {
        ...
        this.jLabelTitle.setText("LISTA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListComponent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListComponent().setVisible(true);
            }
        });
    }
