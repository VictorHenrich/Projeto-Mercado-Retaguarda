...
public class RegistrationPersonComponent extends javax.swing.JFrame {
    ...
    public RegistrationPersonComponent() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextFieldPhone1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jTextFieldPhone2.setBackground(new java.awt.Color(50, 50, 50));
        jTextFieldPhone2.setForeground(new java.awt.Color(190, 190, 190));
        jTextFieldPhone2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    public static void main(String args[]) {;;
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrationPersonComponent().setVisible(true);
            }
        });
    }
