...
public class AddressListComponent extends AbstractListComponent {


    public AddressListComponent() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        this.jLabelTitle.setText("Endereços");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(this.jPanelFooter, javax.swing.GroupLayout.DEFAULT_SIZE, 777, Short.MAX_VALUE)
