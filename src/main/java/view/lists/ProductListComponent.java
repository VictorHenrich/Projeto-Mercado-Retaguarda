...
public class ProductListComponent extends AbstractListComponent {
    ...
    private void initComponents() {
        ...
        this.jLabelTitle.setText("Produtos");
        ...
        this.jTableList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Descrição", "Codigo Barras", "Valor Venda", "UN Venda"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(this.jPanelFooter, javax.swing.GroupLayout.DEFAULT_SIZE, 820, Short.MAX_VALUE)
